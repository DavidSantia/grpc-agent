...
var file_go_agent_proto_rawDesc = []byte{
	...
	0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x3f, 0x0a, 0x09, 0x43, 0x72, 0x65,
	0x61, 0x74, 0x65, 0x41, 0x70, 0x70, 0x12, 0x32, 0x0a, 0x09, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	0x41, 0x70, 0x70, 0x12, 0x11, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2e, 0x41, 0x70, 0x70,
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x1a, 0x10, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2e,
	0x41, 0x70, 0x70, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x3b,
...
var file_go_agent_proto_depIdxs = []int32{
	0, // 0: protos.CreateApp.CreateApp:input_type -> protos.AppConfig
	1, // 1: protos.CreateApp.CreateApp:output_type -> protos.AppReply
...
type CreateAppClient interface {
	CreateApp(ctx context.Context, in *AppConfig, opts ...grpc.CallOption) (*AppReply, error)
}
...
func (c *createAppClient) CreateApp(ctx context.Context, in *AppConfig, opts ...grpc.CallOption) (*AppReply, error) {
	out := new(AppReply)
	err := c.cc.Invoke(ctx, "/protos.CreateApp/CreateApp", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CreateAppServer interface {
	CreateApp(context.Context, *AppConfig) (*AppReply, error)
}
...
func (*UnimplementedCreateAppServer) CreateApp(context.Context, *AppConfig) (*AppReply, error) {
...
func _CreateApp_CreateApp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AppConfig)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CreateAppServer).CreateApp(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.CreateApp/CreateApp",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CreateAppServer).CreateApp(ctx, req.(*AppConfig))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _CreateApp_CreateApp_Handler,
		},
	},
